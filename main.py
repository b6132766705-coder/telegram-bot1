...
async def cmd_help(message: Message):
    help_text = (
        ...
        "<b>💰 Экономика:</b>\n"
        "• <code>б</code> или <code>Профиль</code> — Твой баланс и статус\n"
        "• <code>🎁 Бонус</code> — Забрать подарок (раз в 24ч)\n"
        "• <code>п [сумма]</code> (в ответ) — Передать деньги другу\n"
        "• <code>🏆 Рейтинг</code> — Топ богачей сервера\n\n"
        
        "<b>🎰 Игры и Азарт:</b>\n"
        "• <code>[сумма] [ставка]</code> — Поставить в рулетку (на число, к, ч)\n"
        "• <code>го</code> — Запустить рулетку (только для тех, кто поставил)\n"
        "• <code>лог</code> — История последних игр\n"
        "• <code>Ставки</code> / <code>Отмена</code> — Управление купоном\n"
        "• <code>дуэль [сумма]</code> (в ответ) — Вызвать игрока на бой\n"
        "• <code>украсть</code> (в ответ) — Попытаться ограбить игрока\n\n"
        
        "<b>🛡 Кланы:</b>\n"
        "• <code>клан</code> — Инфо о клане или меню создания\n"
        "• <code>Вступить [Название]</code> — Подать заявку в клан\n"
        "• <code>В казну [сумма]</code> — Пополнить общак\n"
        "• <code>Из казны [сумма]</code> — Забрать (только Лидер)\n"
        "• <code>Покинуть клан</code> — Уйти в свободное плавание\n\n"
        
        "<i>Для новичков: просто добавь друга в чат и получи 10 000 Угадаек!</i>"
    )
